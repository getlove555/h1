...
cl = LINETCR.LINE()
cl.login(token='EoL1QwdepbtBw81Ri8Oc.YLgVP2FFH7O3buLlL8m1xa.BOtU97o/OmS16ydPfGEk5SsvGBg4bDZwLZaiWs036+M=')
cl.loginResult()

kk = LINETCR.LINE()
kk.login(token='EoDoya8Kzg4iEofYLL5f.+N7cEp6EA/PZBKGTFUuatW.7DJ3nRrSYECQAwczQBXBhtf5L/O9dPYU/+RMD9jny14')
kk.loginResult()

ki = LINETCR.LINE()
ki.login(token='EotdVUyzgKxUZ8lxO157.MRMd87JLMY8NA0SCe7JEXW.Aja3em3jJx7SHBuUdn9MpcCCLLcHA3ziwuJcX1ZPr4E')
ki.loginResult()
